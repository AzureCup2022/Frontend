...
import { BaseControlOptions } from '../components/Maps/Legend/BaseControl';
import { DynamicLayerGroup, LayerGroup, LayerState, LegendType } from '../components/Maps/Legend';
